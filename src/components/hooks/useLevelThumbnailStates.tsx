...
// TODO: Extract this hook into a new file and replace it with a hook that
// loads thumbnails from their course IDs and handles the rest of the logic.
 ...
 */
function useLevelThumbnailStates(initState: LevelThumbnailStates): LevelThumbnailStates {
...
export default useLevelThumbnailStates;
